...
:EXPORT_DATE: 2022-06-05
:EXPORT_HUGO_MENU: :menu main :weight -90 :pre user
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :slug about
:EXPORT_HUGO_CUSTOM_FRONT_MATTER+: :description May the sapphire star lights your way✨
:EXPORT_HUGO_CUSTOM_FRONT_MATTER+: :license CC BY-NC-ND
...
:EXPORT_DATE: 2022-06-05
:EXPORT_HUGO_MENU: :menu main :weight -70 :pre archives
...
:EXPORT_DATE: 2022-06-05
:EXPORT_HUGO_MENU: :menu main :weight -60 :pre search
...
* Coding                                                            :@coding:
** Initialize std::array at Compile Time              :cpp:meta_programming:
:PROPERTIES:
:EXPORT_FILE_NAME: initialize-std-array-at-compile-time
:EXPORT_DATE: 2022-03-16
:END:
*** Background
...
* Tech                                                                :@tech:
** Windows + Linux 双系统引导手记               :多系统引导:中文:multi_boot:
:PROPERTIES:
:EXPORT_FILE_NAME: Windows-Linux双系统引导手记
:EXPORT_DATE: 2017-04-05
:END:
*** 0x00 情况简述
...
** Git 中的 Subtree 和 Submodule                                  :git:中文:
:PROPERTIES:
:EXPORT_FILE_NAME: Git中的Subtree和Submodule
:EXPORT_DATE: 2017-04-07
:END:
...
** Dual-booting Windows VHD and Native Linux on a BIOS+GPT PC   :multi_boot:
:PROPERTIES:
:EXPORT_FILE_NAME: dual-booting-windows-vhd-and-native-linux-on-a-bios-gpt-pc
:EXPORT_DATE: 2021-07-09
:END:
*** Background
...
** Fix Metadata in Google Photo Takeout                       :google_photo:
:PROPERTIES:
...
** Minimalist's Multi-boot USB Drive                            :multi_boot:
:PROPERTIES:
...
** Setup A Gaming VM                       :gaming:kvm:qemu:gpu_passthrough:
:PROPERTIES:
...
** Shadowsocks Quick Setup                               :shadowsocks:proxy:
:PROPERTIES:
...
* Grumble                                                          :@grumble:
** Moving From Vim to Emacs                          :vim:emacs:text_editor:
:PROPERTIES:
