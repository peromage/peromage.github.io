...
* Emacs                                                              :@emacs:
** Use Org Mode to Manage My Blog                  :emacs:org:markdown:hugo:
:PROPERTIES:
...
** Use Git Worktree to Work with Multiple Checkout at the Same Time    :git:
:PROPERTIES:
:EXPORT_FILE_NAME: use-git-worktree-to-work-with-multiple-checkout-at-the-same-time
:EXPORT_DATE: 2022-06-06
:END:
*** Troubles
